...
from admin.code_hygiene.scanners.virtual_ast_buffer import (  # noqa: E402
    VirtualASTBuffer,
...
def get_model_provider_name(model: Any) -> str:
    ...
    from admin.controls.controls import PROVIDERS
...
async def refactor_single_attempt_with_llm(
    ...
    try:
        ...
        baseline_errors = get_file_baseline_errors(candidate.file_path, repo_root) if full_source else set()
