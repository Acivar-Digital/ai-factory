# admin/code_hygiene/scanners/verify_dict_access_runtime.py
#
...
def build_sample_profile() -> ChartProfile:
...
def load_candidates() -> list[dict[str, Any]]:
    reports_dir = workspace_root() / "admin" / "code_hygiene" / "reports"
    json_path = reports_dir / "dict_access_on_models.json"
    sample_path = workspace_root() / "admin" / "studio" / "upload" / "dict_access_on_models_sample.json"
