...
Usage:
    uv run python 10_harness_suite/_shared/agent_guardrail.py checkpoint <file>
    uv run python 10_harness_suite/_shared/agent_guardrail.py validate <file>
    uv run python 10_harness_suite/_shared/agent_guardrail.py diff <file>
    uv run python 10_harness_suite/_shared/agent_guardrail.py full <file>
    uv run python 10_harness_suite/_shared/agent_guardrail.py cc-check <file>
    uv run python 10_harness_suite/_shared/agent_guardrail.py pydantic-check <file>
"""
...
HARNESS_DIR = PROJECT_ROOT / "admin" / "orchestrator"  # Annot: your-repo-only; guarded by _index_harness_dir is_dir check
