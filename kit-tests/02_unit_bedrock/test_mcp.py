...
def test_get_file_symbols():
    result = call_tool("get_file_symbols", relative_path="your-repo/src/bot/app.py")
...
def test_read_file():
    result = call_tool("read_file", relative_path="your-repo/src/bot/app.py", start_line=1, end_line=10)
...
def test_list_files():
    result = call_tool("list_files", directory="your-repo/src/bot")
    assert result.get("success") is True, f"list_files failed: {result.get('message')}"
    items = result.get("items", [])
    print(f"    Found {len(items)} items in your-repo/src/bot")


# ── Edit Lane ────────────────────────────────────────────────

def test_write_and_read_file():
    test_path = "your-repo/_test_write_file.py"
...
def test_replace_in_file():
    test_path = "your-repo/_test_replace_file.py"
...
def test_rename_file():
    test_path = "your-repo/_test_rename_old.py"
    renamed_path = "your-repo/_test_rename_new.py"
...
def test_ast_clean_imports():
    test_path = "your-repo/_test_imports.py"
...
def test_count_lines():
    result = call_tool("count_lines", files=["your-repo/src/bot/app.py", "your-repo/src/engine/bazi_data.py"])
