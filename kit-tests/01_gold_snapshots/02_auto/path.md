...
4. **User sends name details (e.g., `Name: Francis Yap, Alias: FYCL, Gender: Male`)**: Bot records details and prompts for date of birth, time of birth, and birth location.
