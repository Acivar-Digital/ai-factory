...
DB_URL = os.getenv("DATABASE_URL") or "postgresql+psycopg2://postgres:postgres@localhost:5432/your-repo"
CHAT_ID = int(os.getenv("GOLD_CHAT_ID", "999"))
# [your-repo-only: TEST/GOLD/actual_artifacts directory not in kit download]
OUT = Path("TEST/GOLD/actual_artifacts")  # [your-repo-only: not in kit download]
