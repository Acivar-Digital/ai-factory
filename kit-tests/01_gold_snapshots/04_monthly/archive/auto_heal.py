...
async def main():
    # Target test command
    # [your-repo-only: TEST/GOLD/run.py not in kit download. See KIT_PATH-based run via 'uv run pytest examples'.]
    # [your-repo-only: TEST/GOLD/run.py not in kit download]
    test_cmd = "uv run TEST/GOLD/run.py --test 04_daily --test 05_forecast"  # [your-repo-only: not in kit download]
