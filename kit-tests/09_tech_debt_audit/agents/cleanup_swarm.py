...
# Annot: TEST/tech_debt reports are your-repo-only; honour KIT_PATH override.
...
def run_tests() -> bool:
    ...
    # Annot: TEST/test_run.py is your-repo-only; guarded by existence check
    ...
    if test_runner.exists():
        ...
        logger.warning("TEST/test_run.py not found — skipping (your-repo-only).")
    return True
