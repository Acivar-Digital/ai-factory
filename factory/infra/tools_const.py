...
INTERN_WRITE_ROOTS = ['factory/temp/']
...
__all__ = ['_logger', '_STEER', '_REMEMBER_NUDGE', 'MAX_BATCH_FILES', '_BATCH_READ_NO_PATHS', '_BATCH_READ_DEFAULT_HEAD', 'INTERN_WRITE_ROOTS', '_BATCH_READ_STEER', '_SRC_BAN_MSG']
